...
* [搭建自己的简易Blog](./docs/Play/easy-online-blog.md)
* [通过Docker快速搭建一个nginx](./docs/Play/static_resource_server.md)
...
* [在VMWare中部署你的K8S集群-二进制](./docs/Kubernetes/quick-start-k8s-cluster-binary.md)
...
* [看看书本上的linux系列](./docs/Linux/look-at-the-book-linux/README.md)
* [哈?操作系统 临时笔记](./docs/Linux/linux-temp-record/README.md)
...
* [如何让用户拥有sudo权限](./docs/A-bit-of-everything/Introduction-to-algorithms/sudo.md)

...
计算公式： `KV 缓存的总大小（以字节为单位）= （batch_size） * （sequence_length） * 2 * （num_layers） * （hidden_size） * sizeof（FP16）`
...
![image-7](https://github.com/ninehills/blog/assets/270298/806ac211-0f9b-48ad-8939-8e6e1361b91d)
...
![image-6](https://github.com/ninehills/blog/assets/270298/f0f9fd0e-6871-4def-b0e4-2856b2bd48d0)
...
具体评测结果参见（持续更新）：[https://github.com/ninehills/llm-inference-benchmark](https://github.com/ninehills/llm-inference-benchmark). 
...
<table>
  <thead>
    <tr>
      <th>Framework</th>
      <th>Producibility<em>**</em></th>
      <th>Docker Image</th>
      <th>API Server</th>
      <th>OpenAI API Server</th>
      <th>WebUI</th>
      <th>Multi Models**</th>
      <th>Multi-node</th>
      <th>Backends</th>
  ...
  <tbody>
    <tr>
      <td><a href="https://github.com/oobabooga/text-generation-webui">text-generation-webui</a></td>
      <td>Low</td>
      <td>Yes</td>
      <td>Yes</td>
      <td>Yes</td>
      ...
      <td>No</td>
      <td>No</td>
      <td>Transformers/llama.cpp/ExLlama/ExLlamaV2/AutoGPTQ/AutoAWQ/GPTQ-for-LLaMa/CTransformers</td>
      <td>No</td>
    </tr>
    <tr>
      <td><a href="https://github.com/bentoml/OpenLLM">OpenLLM</a></td>
      <td>High</td>
      <td>Yes</td>
      <td>Yes</td>
      <td>Yes</td>
      <td>No</td>
      <td>With <a href="https://github.com/bentoml/BentoML">BentoML</a></td>
      <td>With <a href="https://github.com/bentoml/BentoML">BentoML</a></td>
      <td>Transformers(int8,int4,gptq), vLLM(awq/squeezellm), TensorRT</td>
      <td>No</td>
    </tr>
    <tr>
      ...
      <td>No</td>
      <td>No</td>
      <td>Yes(With <a href="https://docs.ray.io/en/latest/ray-core/starting-ray.html">Ray</a>)</td>
      <td>vLLM</td>
      <td>No</td>
    </tr>
    <tr>
      <td><a href="https://github.com/xorbitsai/inference">Xinference</a></td>
      <td>High</td>
      <td>Yes</td>
      <td>Yes</td>
      <td>Yes</td>
      ...
      <td>Yes</td>
      <td>Yes</td>
      <td>Transformers/vLLM/TensorRT/GGML</td>
      <td>Yes</td>
    </tr>
    <tr>
      ...
      <td>No</td>
      <td>No</td>
      <td>Transformers/AutoGPTQ/AWQ/EETP/vLLM/ExLlama/ExLlamaV2</td>
      <td>No</td>
    </tr>
    <tr>
      <td><a href="https://github.com/vectorch-ai/ScaleLLM">ScaleLLM</a></td>
      <td>Medium</td>
      <td>Yes</td>
      <td>Yes</td>
      <td>Yes</td>
      ...
      <td>No</td>
      <td>No</td>
      <td>Transformers/AutoGPTQ/AWQ/vLLM/ExLlama/ExLlamaV2</td>
      <td>No</td>
    </tr>
    <tr>
...
<ul>
  <li>*vLLM/TGI can also serve as a backend.</li>
  <li>**Multi Models: Capable of loading multiple models simultaneously.</li>
  <li>***TGI does not support chat mode; manual parsing of the prompt is required.</li>
</ul>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>High</td>
      <td>Yes</td>
      <td><a href="https://github.com/TimDettmers/bitsandbytes">bitsandbytes</a>(int8/int4), <a href="https://github.com/PanQiWei/AutoGPTQ">AutoGPTQ</a>(gptq), AutoAWQ(awq)</td>
      <td>Yes</td>
      <td><a href="https://huggingface.co/docs/accelerate/index">accelerate</a></td>
      <td>Yes</td>
    </tr>
    <tr>
      <td><a href="https://github.com/vllm-project/vllm">vLLM</a></td>
      ...
      <td>High</td>
      <td>No</td>
      <td>awq/squeezellm</td>
      <td>Yes</td>
      <td>Yes</td>
      <td>Yes</td>
    </tr>
    <tr>
      <td><a href="https://github.com/turboderp/exllamav2">ExLlamaV2</a></td>
      <td>GPU/CPU</td>
      <td>Low</td>
      <td>No</td>
      <td>GPTQ</td>
    ...
    <tr>
      <td><a href="https://github.com/NVIDIA/TensorRT-LLM">TensorRT</a></td>
      <td>GPU</td>
      <td>Medium</td>
      <td>No</td>
      <td><a href="https://github.com/NVIDIA/TensorRT-LLM/blob/main/docs/source/precision.md">some models</a></td>
      <td>Yes</td>
      <td>Yes</td>
      <td>Yes</td>
    </tr>
    ...
    <tr>
      <td><a href="https://github.com/OpenNMT/CTranslate2">CTranslate2</a></td>
      <td>GPU</td>
      <td>Low</td>
      <td>No</td>
      <td>Yes</td>
    ...
    <tr>
      ...
      <td>Medium</td>
      <td>Yes</td>
      <td>awq/eetq/gptq/bitsandbytes</td>
      <td>Yes</td>
      <td>Yes</td>
      <td>Yes</td>
    </tr>
    ...
    <tr>
      <td><a href="https://github.com/microsoft/DeepSpeed/tree/master/blogs/deepspeed-fastgen">Deepspeed-FastGen</a></td>
      <td>GPU</td>
      <td>Low</td>
      <td>No</td>
      <td>No</td>
...
<ul>
  <li>*PEFT Adapters: support to load seperate PEFT adapters(mostly lora).</li>
  <li>**Compatibility: High: Compatible with most models; Medium: Compatible with some models; Low: Compatible with few models.</li>
  <li>***llama.cpp’s Python binding: <a href="https://github.com/abetlen/llama-cpp-python">llama-cpp-python</a>.</li>
</ul>
...
<table>
  ...
  <tbody>
    <tr>
      <td>text-generation-webui Transformer</td>
      <td>40.39</td>
      <td>0.15</td>
      <td>41.47</td>
      <td>0.21</td>
    ...
    <tr>
      <td>text-generation-webui Transformer with flash-attention-2</td>
      <td>58.30</td>
      <td>0.21</td>
      <td>43.52</td>
      <td>0.21</td>
    ...
    <tr>
      <td>text-generation-webui ExllamaV2</td>
      <td>69.09</td>
      <td>0.26</td>
      <td>50.71</td>
      <td>0.27</td>
...
<ul>
  <li><strong>bs</strong>: Batch Size. <code class="language-plaintext highlighter-rouge">bs=4</code> indicates the batch size is 4.</li>
  <li><strong>TPS</strong>: Tokens Per Second.</li>
  <li><strong>QPS</strong>: Queries Per Second.</li>
  <li><strong>FTL</strong>: First Token Latency, measured in milliseconds. Applicable <strong>only</strong> in stream mode.</li>
</ul>
